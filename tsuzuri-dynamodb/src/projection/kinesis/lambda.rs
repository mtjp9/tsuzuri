...
mod tests {
    ...
    async fn test_process_kinesis_lambda_event_success() {
        ...
        // Create test data
        let stream_data1 = create_dynamodb_stream_data("TestEvent", b"payload1", b"metadata1");
        let stream_data2 = create_dynamodb_stream_data("TestEvent", b"payload2", b"metadata2");
    ...
    async fn test_process_kinesis_lambda_event_with_error() {
        ...
        let stream_data = create_dynamodb_stream_data("TestEvent", b"payload", b"metadata");
