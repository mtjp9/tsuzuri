...
- Adapted to tsuzuri's decoupled IntegrationEvent architecture
  - Updated Persister trait implementation to accept optional integration events
  - Handle None case for integration events with unwrap_or
  - Removed test implementations of IntoIntegrationEvents
  - Updated all persist calls in tests to use new API signature
