...
mod tests {
    ...
    fn test_error_display() {
        ...
        let invalid_data_error = ProjectionError::InvalidData("Bad format".to_string());
        assert_eq!(invalid_data_error.to_string(), "Invalid data: Bad format");

        let stream_error = ProjectionError::StreamProcessing("Stream closed".to_string());
    ...
    fn test_json_error_conversion() {
        ...
        let projection_error: ProjectionError = json_error.into();
        assert!(matches!(projection_error, ProjectionError::Json(_)));
        assert!(projection_error.to_string().starts_with("Json error:"));
    }
